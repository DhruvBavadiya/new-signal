...
const { addSignalLightData, signalByCoordinates, getAll, getSignalById, updateSignal, getSignalsByCircleId, liveUpdateSignal, signalOff, signalOn, DeleteSIgnal, DeleteSignal } = require("../Controller/SignalLightController");
